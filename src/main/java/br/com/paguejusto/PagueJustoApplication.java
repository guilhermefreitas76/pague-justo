...
import br.com.paguejusto.domain.PagamentoComCartao;
...
public class PagueJustoApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(PagueJustoApplication.class, args);
	}
